...
int git_refspec_transform(git_buf* buf_out, const(git_refspec)* spec, const(char)* name);
int git_refspec_rtransform(git_buf* buf_out, const(git_refspec)* spec, const(char)* name);